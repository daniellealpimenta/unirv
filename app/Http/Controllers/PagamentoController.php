...
class PagamentoController extends Controller
{
    public function pagarPix(Request $request, MercadoPagoService $mp)
    {
        ...
        try {
            ...
            // Adiciona o erro no log para não perder o histórico também
            \Log::error('Erro ao tentar criar pagamento: ' . $e->getMessage());

            return response()->json([
                'error' => 'Falha ao criar pagamento: ' . $e->getMessage(),
            ], 500);
        }
    }
}
